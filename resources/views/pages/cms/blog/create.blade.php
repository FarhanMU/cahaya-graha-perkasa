...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> <a
                href="{{ route('blog.index') }}">Blog</a> / Create Blog</h4>
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="title_en" class="form-control"
                                                    ...
                                                    value="{{ old('content.en.title') }}" required />
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="title_id" class="form-control"
                                                    ...
                                                    value="{{ old('content.id.title') }}" required />
                                            </div>
                                            <div class="mb-3">
